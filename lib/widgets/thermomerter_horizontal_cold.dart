...
class ThermoTestHorizontalCold extends StatefulWidget {
  final double value;

  const ThermoTestHorizontalCold({Key? key, required this.value})
      : super(key: key);
  @override
  State<ThermoTestHorizontalCold> createState() => _ThermoTestHorizontal();
}

class _ThermoTestHorizontal extends State<ThermoTestHorizontalCold> {
  @override
