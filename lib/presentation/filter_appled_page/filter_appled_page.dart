...
import 'controller/filter_appled_controller.dart';
import 'models/filter_appled_model.dart';

class FilterAppledPage extends StatelessWidget {
  FilterAppledPage({Key? key})
      : super(
          key: key,
        );

  FilterAppledController controller =
      Get.put(FilterAppledController(FilterAppledModel().obs));
  ...
  PreferredSizeWidget _buildAppBar() {
    return CustomAppBar(
      ...
      actions: [
        AppbarTrailingImage(
          imagePath: ImageConstant.imgFilterHorizontal,
