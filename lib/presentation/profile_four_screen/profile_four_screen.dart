...
import '../profile_four_screen/widgets/frametwentythree4_item_widget.dart';
import '../profile_four_screen/widgets/frametwentythree6_item_widget.dart';
...
class ProfileFourScreen extends GetWidget<ProfileFourController> {
  const ProfileFourScreen({Key? key})
      : super(
          key: key,
        );
                  ...
                  Obx(
                    () => SizedBox(
                      ...
                      child: AnimatedSmoothIndicator(
                        ...
                        count: controller.profileFourModelObj.value
  ...
  Widget _buildWidget() {
    return Obx(
      () => CarouselSlider.builder(
        ...
        itemCount:
            controller.profileFourModelObj.value.widget1ItemList.value.length,
        itemBuilder: (context, index, realIndex) {
          Widget1ItemModel model =
              controller.profileFourModelObj.value.widget1ItemList.value[index];
          ...
          Obx(
            () => Wrap(
              ...
              children: List<Widget>.generate(
                controller.profileFourModelObj.value.frametwentythree4ItemList
                    .value.length,
                (index) {
                  Frametwentythree4ItemModel model = controller
                      .profileFourModelObj
                      .value
                      .frametwentythree4ItemList
                      .value[index];

                  return Frametwentythree4ItemWidget(
                    model,
                  );
                },
              ),
        ...
        children: [
          ...
          Obx(
            () => Wrap(
              ...
              spacing: 12.h,
              children: List<Widget>.generate(
                controller.profileFourModelObj.value.frametwentythree6ItemList
                    .value.length,
                (index) {
                  Frametwentythree6ItemModel model = controller
                      .profileFourModelObj
                      .value
                      .frametwentythree6ItemList
                      .value[index];

                  return Frametwentythree6ItemWidget(
                    model,
                  );
                },
              ),
